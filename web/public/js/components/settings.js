...
const SettingsComponent = (() => {
  ...
  const CONFIG_GROUPS = [
    ...
    {
      id: 'hal_pid_params',
      label: 'HAL - PID Controller',
      restartRequired: false,
      fields: [
        { key: 'hal_pid_kp', label: 'Kp (Proportional)', type: 'number', min: 0, max: 100, step: 0.01 },
        { key: 'hal_pid_ki', label: 'Ki (Integral)', type: 'number', min: 0, max: 100, step: 0.01 },
        { key: 'hal_pid_kd', label: 'Kd (Derivative)', type: 'number', min: 0, max: 100, step: 0.01 },
        { key: 'hal_pid_integral_limit', label: 'Integral Limit', type: 'number', min: 0, max: 100000, step: 1 },
        { key: 'hal_pid_output_limit', label: 'Output Limit', type: 'number', min: 0, max: 1000, step: 1 },
        { key: 'hal_pid_anti_windup_gain', label: 'Anti-Windup Gain', type: 'number', min: 0, max: 10, step: 0.01 },
        { key: 'hal_pid_enable_anti_windup', label: 'Enable Anti-Windup', type: 'checkbox' },
      ],
    },
    {
      id: 'hal_safety',
      label: 'HAL - Safety Monitoring',
      restartRequired: false,
      fields: [
        { key: 'hal_safety_enable_limits', label: 'Enable Limits', type: 'checkbox' },
        { key: 'hal_safety_enable_emergency_stop', label: 'Enable Emergency Stop', type: 'checkbox' },
        { key: 'hal_safety_emergency_stop_timeout_ms', label: 'E-Stop Timeout (ms)', type: 'number', min: 10, max: 10000 },
        { key: 'hal_safety_enable_temperature_monitoring', label: 'Temperature Monitoring', type: 'checkbox' },
        { key: 'hal_safety_enable_current_monitoring', label: 'Current Monitoring', type: 'checkbox' },
        { key: 'hal_safety_enable_voltage_monitoring', label: 'Voltage Monitoring', type: 'checkbox' },
        { key: 'hal_safety_min_voltage', label: 'Min Voltage (V)', type: 'number', min: 0, max: 100, step: 0.1 },
        { key: 'hal_safety_max_voltage', label: 'Max Voltage (V)', type: 'number', min: 0, max: 100, step: 0.1 },
        { key: 'hal_safety_monitoring_rate', label: 'Monitoring Rate (Hz)', type: 'number', min: 1, max: 1000 },
      ],
    },
    {
      id: 'hal_axes',
  ...
  const GROUP_ICONS = {
    ...
    hal_pid_params:   '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>',
    hal_safety:       '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',
  ...
  const GROUP_HELP = {
    ...
    hal_safety: 'Monitoring bezpiecze\u0144stwa: limity napi\u0119cia, monitoring temperatury, pr\u0105du i napi\u0119cia, emergency stop.',
